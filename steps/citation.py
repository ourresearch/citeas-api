...
class CitationFileStep(Step):
    ...
    def starting_children(self):
        if self.host == "cran":
            return [BibtexStep, CrossrefResponseStep, CitentryStep]
        else:
            return [CrossrefResponseStep, CitentryStep, BibtexStep]
