...
test_urls = [
    ...
    ("http://cran.r-project.org/package=arcos", "", "Steven, R., Andrew, B. & Aaron, W., 2020. arcos: Load ARCOS Prescription Data Prepared by the Washington Post. <i>R package version 1.0</i>. Available at: https://CRAN.R-project.org/package=arcos."),
